...
public class SSSchedulerMonth extends SSSchedulerBase {
	...
	public String getDisplayName(int index) {
		return getDateList().get(index).toString("MMMM YYYY");
	}
